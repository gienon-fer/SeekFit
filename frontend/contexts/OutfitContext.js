...
import { useClothing } from './ClothingContext'; // Import useClothing
...
export function OutfitProvider({ children }) {
  ...
  const { clothes, getClothingByServerIds } = useClothing(); // Get clothes and getClothingByServerIds from ClothingContext
